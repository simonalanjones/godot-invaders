...
var enabled = true
var max_bombs = 1
var grace_period_count = 60 # allow short time before dropping bombs
onready var bomb_scene = preload("res://scenes/Bomb.tscn")

# adjust reload rate depending on score amount eg 200/1000/2000

	
func start_bombs():
	enabled = true
	grace_period_count = 60
...
func get_reload_speed():
	# this should be affected by player score
	return 38
